#!/bin/bash
# Given a URL, returns all of its relative and absolute links.
...
# (the opposite of -i). Make sure you have installed lynx prior triggering bash
# Pass URL in commadline to fetch site links like jainarayansingh.wordpress.com
